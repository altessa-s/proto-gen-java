...
public final class ServiceInfoServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      io.altessa.serviceinfo.v1.ServiceInfo> getGetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Get",
      requestType = com.google.protobuf.Empty.class,
      responseType = io.altessa.serviceinfo.v1.ServiceInfo.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      io.altessa.serviceinfo.v1.ServiceInfo> getGetMethod() {
    io.grpc.MethodDescriptor<com.google.protobuf.Empty, io.altessa.serviceinfo.v1.ServiceInfo> getGetMethod;
    if ((getGetMethod = ServiceInfoServiceGrpc.getGetMethod) == null) {
      synchronized (ServiceInfoServiceGrpc.class) {
        if ((getGetMethod = ServiceInfoServiceGrpc.getGetMethod) == null) {
          ServiceInfoServiceGrpc.getGetMethod = getGetMethod =
              io.grpc.MethodDescriptor.<com.google.protobuf.Empty, io.altessa.serviceinfo.v1.ServiceInfo>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.altessa.serviceinfo.v1.ServiceInfo.getDefaultInstance()))
              .setSchemaDescriptor(new ServiceInfoServiceMethodDescriptorSupplier("Get"))
              .build();
        }
      }
    }
  ...
  public interface AsyncService {
    ...
    default void get(com.google.protobuf.Empty request,
        io.grpc.stub.StreamObserver<io.altessa.serviceinfo.v1.ServiceInfo> responseObserver) {
  ...
  private static abstract class ServiceInfoServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.altessa.serviceinfo.v1.ServiceinfoService.getDescriptor();
    }
